                ...
                <div className="mt-8 w-full max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
                    ...
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div className="p-4">
                            ...
                            <a 
                                href="https://hmc-edu.zoom.us/j/99804383799?pwd=iAmnSn80kgUBZyYTiC5Q3GBbJ3lQMw.1" 
                                target="_blank" 
                                rel="noopener noreferrer" 
                    ...
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        <Image 
                            ...
                            />
                        <div className="p-4">
                            <h3 className="text-xl font-semibold text-blue-800">History of The Americas</h3>
                            <a 
